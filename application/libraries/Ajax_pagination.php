...
class Ajax_pagination{
	...
	var $prev_link			  = "<i class='bx bx-chevrons-left'></i>";

	var $next_link			  = "<i class='bx bx-chevrons-right'></i>";

	var $last_link			  = 'Dernier';

	var $uri_segment		  = 3;

	var $full_tag_open		= '<div class="page-navigation-area"><nav><ul class="pagination">';

	var $full_tag_close		= '</nav></ul></div>';
	...
	var $cur_tag_open		  = '<li class="page-item active"><a class="page-link page-links" href="#">';

	var $cur_tag_close		= '</a></li>';

	var $next_tag_open		= '<li class="page-item"><a class="page-link page-links" href="#">';

	var $next_tag_close		= '</a></li>';

	var $prev_tag_open		= '<li class="page-item"><a class="page-link page-links" href="#">';

	var $prev_tag_close		= '</a></li>';

	var $num_tag_open		  = '<li class="page-item"><a class="page-link page-links" href="#">';
