...
<!--<section id="bodytv">
  ...
  <div id="containertv">-->
   ...
   <!-- <div id="topbartv">
    ...
    <!--   <iframe width="882" height="496" src="<?php //foreach($lienTv as $row_tv):echo $row_tv->lien_tv;endforeach;?>" frameborder="0" allow="accelerometer; autoplay=1; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div> -->
...
<section class="testimonials-area-two testimonials-area-page" style="padding-top: 30px; padding-bottom: 100px">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="single-testimonials-two" style="border: 1px solid; box-shadow: 5px 10px grey; border-radius: 45%;">
                    ...
                    <h3 style="font-family: Arial"> <?php echo $row->libelle_tv   ?></h3>
                        <a href="<?php echo $row->lien_tv?>" class="btn btn-secondary">SUIVRE LE COUR ICI</a>
