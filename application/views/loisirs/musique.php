...
<?php foreach ($bannerMusiqueLoisiris as $row_M):  ?>
<div class="bg-15 banner-display-phone" style="position: relative;
    ...
    text-align: center;
    z-index: 1;
    background-image: url('<?php echo site_url('assets/banniere/loisir/'.$row_M->file_banner_loisir_musique) ?>');
...
<section class="" style="padding-top: 30px; background-image: url('<?php echo site_url() ?>assets/img/events/event-bg.jpg')">
    ...
    <div class="spaceAudio">
        ...
        <audio id="audio" preload="none" tabindex="0">
            ...
            <?php foreach ($allMusiqueLoisiris as $row): ?>
                <source src="<?php echo site_url('assets/loisirs/musique/'.$row->file_loisirs_musique) ?>" data-track-number="<?php echo $row->id_loisirs_musique ?>" />
            <?php  endforeach; ?>
        ...
        <div class="play-list">
            ...
            <?php $count = 1; ?>
            <?php  foreach ($allMusiqueLoisiris as $row):  ?>
                <div class="play-list-row" data-track-row="<?php echo $row->id_loisirs_musique;  ?>">
                    ...
                    <div class="track-title">
                        <a class="playlist-track" href="#" data-play-track="<?php echo $row->id_loisirs_musique;  ?>"><?php echo $row->title_loisirs_musique;  ?></a>
                    </div>
                </div>
