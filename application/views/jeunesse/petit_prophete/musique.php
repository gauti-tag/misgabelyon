...
<?php foreach ($bannerMusiquePetit as $row_banner_petit): ?>
...
<div class="bg-15 banner-display-phone" style="position: relative;
    ...
    text-align: center;
    z-index: 1;
    background-image: url('<?php echo site_url('assets/banniere/jeunesse/petit/'.$row_banner_petit->file_banner_jeunesse_petits_musique) ?>');
...
<!--<style>
    ...
    @media (min-width: 1200px) {
     ...
     .spaceAudio .player .large-toggle-btn {
     ...
     .spaceAudio .player .large-toggle-btn .large-play-btn {
        cursor: pointer;
        display: inline-block;
        position: relative;
        top: -14%;
    }
     .spaceAudio .player .large-toggle-btn .large-play-btn:before {
        content: "\f04b";
        font: 1.5em/1.75 "FontAwesome";
    }
     .spaceAudio .player .large-toggle-btn .large-pause-btn {
        cursor: pointer;
        display: inline-block;
        position: relative;
        top: -13%;
    }
     .spaceAudio .player .large-toggle-btn .large-pause-btn:before {
        content: "\f04c";
        font: 1.5em/1.75 "FontAwesome";
    }
     .spaceAudio .player .info-box {
        bottom: 10px;
        left: 65px;
        position: absolute;
        top: 15px;
    }
     .spaceAudio .player .info-box .track-info-box {
        float: left;
        font-size: 12px;
        margin: 0 0 6px 0;
        visibility: hidden;
     ...
     .spaceAudio .player .info-box .track-info-box .track-title-text {
        display: inline-block;
    }
     .spaceAudio .player .info-box .track-info-box .audio-time {
        display: inline-block;
        padding: 0 0 0 5px;
        width: 80px;
    }
     .spaceAudio .player .info-box .track-info-box:before,  .spaceAudio .player .info-box .track-info-box:after {
        content: " ";
        display: table;
    }
     .spaceAudio .player .info-box .track-info-box:after {
        clear: both;
        display: block;
        font-size: 0;
        height: 0;
     ...
     .spaceAudio .player .progress-box {
        float: left;
        min-width: 270px;
        position: relative;
    }
     .spaceAudio .player .progress-box .progress-cell {
        height: 12px;
        position: relative;
    }
     .spaceAudio .player .progress-box .progress-cell .progress {
        background: #fff;
        border: 1px solid #d9d9d9;
        height: 8px;
        position: relative;
     ...
     .spaceAudio .player .progress-box .progress-cell .progress .progress-buffer {
        background: #337ab7;
        height: 100%;
        width: 0;
    }
     .spaceAudio .player .progress-box .progress-cell .progress .progress-indicator {
        background: #fff;
     ...
     .spaceAudio .player .controls-box {
        bottom: 10px;
        left: 350px;
        position: absolute;
    }
     .spaceAudio .player .controls-box .previous-track-btn {
        cursor: pointer;
        display: inline-block;
    }
     .spaceAudio .player .controls-box .previous-track-btn:before {
        content: "\f049";
        font: 1em "FontAwesome";
    }
     .spaceAudio .player .controls-box .next-track-btn {
        cursor: pointer;
        display: inline-block;
    }
     .spaceAudio .player .controls-box .next-track-btn:before {
        content: "\f050";
        font: 1em "FontAwesome";
    }
     .spaceAudio .player:before,  .spaceAudio .player:after {
        content: " ";
        display: table;
    }
     .spaceAudio .player:after {
        clear: both;
        display: block;
        font-size: 0;
        height: 0;
     ...
     .spaceAudio .play-list .play-list-row {
        display: block;
        margin: 10px 0;
        width: 100%;
        *zoom: 1;
    }
     .spaceAudio .play-list .play-list-row .track-title .playlist-track {
        color: #000;
        text-decoration: none;
    }
     .spaceAudio .play-list .play-list-row .track-title .playlist-track:hover {
        text-decoration: underline;
    }
     .spaceAudio .play-list .play-list-row .small-toggle-btn {
        border: 1px solid #d9d9d9;
        border-radius: 2px;
        cursor: pointer;
        display: inline-block;
     ...
     .spaceAudio .play-list .play-list-row .small-toggle-btn .small-play-btn {
        display: inline-block;
    }
     .spaceAudio .play-list .play-list-row .small-toggle-btn .small-play-btn:before {
        content: "\f04b";
        font: 0.85em "FontAwesome";
    }
     .spaceAudio .play-list .play-list-row .small-toggle-btn .small-pause-btn {
        display: inline-block;
    }
     .spaceAudio .play-list .play-list-row .small-toggle-btn .small-pause-btn:before {
        content: "\f04c";
        font: 0.85em "FontAwesome";
    }
     .spaceAudio .play-list .play-list-row .track-number {
        display: inline-block;
    }
     .spaceAudio .play-list .play-list-row .track-title {
        display: inline-block;
    }
     .spaceAudio .play-list .play-list-row .track-title .playlist-track {
        text-decoration: none;
     ...
     .spaceAudio .play-list .play-list-row .track-title.active-track {
        font-weight: bold;
    }
     .spaceAudio .play-list .play-list-row:before,  .spaceAudio .play-list .play-list-row:after {
        content: " ";
        display: table;
    }
     .spaceAudio .play-list .play-list-row:after {
        clear: both;
        display: block;
        font-size: 0;
        height: 0;
...
<section class="" style="padding-top: 30px; background-image: url('<?php echo site_url() ?>assets/img/team/people-bg-1.jpg')">

     <div class="container">
         <div class="row">
             <div class="col-md-12">
                 <div class="spaceAudio">

                     <audio id="audio" preload="none" tabindex="0">

                         <?php foreach ($allAudioPetit as $row): ?>
                             <source src="<?php echo site_url('assets/jeunesse/musique/petit/'.$row->file_jeunesse_musique_petit) ?>" data-track-number="<?php echo $row->id_jeunesse_musique_petit ?>" />
                         <?php  endforeach; ?>
                     ...
                     <div class="play-list">
                         <?php $count = 1; ?>
                         <?php  foreach ($allAudioPetit as $row):  ?>
                             <div class="play-list-row" data-track-row="<?php echo $row->id_jeunesse_musique_petit;  ?>">
                                 ...
                                 <div class="track-title">
                                     <a class="playlist-track" href="#" data-play-track="<?php echo $row->id_jeunesse_musique_petit;  ?>"><?php echo $row->title_jeunesse_musique_petit;  ?></a>
                                 </div>
                             </div>
