...
<?php foreach ($bannerLivrePetit as $row_b): ?>
...
<div class="bg-15 banner-display-phone" style="position: relative;
    ...
    text-align: center;
    z-index: 1;
    background-image: url('<?php echo site_url('assets/banniere/jeunesse/petit/'.$row_b->file_banner_jeunesse_petits_livre) ?>');
...
<section class="team-area pb-70" style="padding-top: 20px">
    <div class="container">
        ...
        <div class="row">
            ...
            <?php foreach ($allLivrePetit as $row_book_petit): ?>

            <div class="col-lg-4 col-sm-6">
                <div class="single-team">
                    <div class="team-img">
                        <img src="<?php echo site_url('assets/jeunesse/livre/petit/'.$row_book_petit->file_jeunesse_livre_petit) ?>" alt="Image">

                        <ul class="team-link">
                        </ul>
                    </div>
                    <div class="team-content">
                        <h5><?php echo $row_book_petit->titre_jeunesse_livre_petit  ?></h5>
                    </div>
                </div>
            </div>
