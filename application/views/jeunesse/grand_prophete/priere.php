...
<?php foreach ($bannerPriereGrand as $row_banner_grand): ?>
...
<div class="bg-15 banner-display-phone" style="position: relative;
    ...
    text-align: center;
    z-index: 1;
    background-image: url('<?php echo site_url('assets/banniere/jeunesse/grand/'.$row_banner_grand->file_banner_jeunesse_grand_priere)?>');
        ...
        <div class="row align-items-center">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="faq-accordion mb-used">
                    <ul class="accordion">
                        <?php  foreach ($allPriereJeune as $row): ?>
                            <li class="accordion-item">
                                <a class="accordion-title" href="javascript:void(0)">
                                    <i class="bx bx-plus"></i>
                                    <?php echo $row->sujet_jeunesse_priere_jeune ?>
                                </a>

                                <div class="accordion-content">
                                    <p> <?php echo $row->content_jeunesse_priere_jeune  ?> </p>
                            </li>
                        <?php endforeach;  ?>
