...
<?php foreach ($bannerMusiqueGrand as $row_banner_grand): ?>
...
<div class="bg-15 banner-display-phone" style="position: relative;
        ...
        text-align: center;
        z-index: 1;
        background-image: url('<?php echo site_url('assets/banniere/jeunesse/grand/'.$row_banner_grand->file_banner_jeunesse_grand_musique) ?>');
...
<section class="" style="padding-top: 30px; background-image: url('<?php echo site_url() ?>assets/img/events/event-bg.jpg')">
            ...
            <div class="col-md-12">
                ...
                <div class="spaceAudio">
                    ...
                    <audio id="audio" preload="none" tabindex="0">
                        ...
                        <?php foreach ($allAudioGrand as $row): ?>
                            <source src="<?php echo site_url('assets/jeunesse/musique/grand/'.$row->file_jeunesse_musique_grand) ?>" data-track-number="<?php echo $row->id_jeunesse_musique_petit ?>" />
                        <?php  endforeach; ?>
                    ...
                    <div class="play-list">
                        ...
                        <?php $count = 1; ?>
                        <?php  foreach ($allAudioGrand as $row):  ?>
                            <div class="play-list-row" data-track-row="<?php echo $row->id_jeunesse_musique_grand;  ?>">
                                ...
                                <div class="track-title">
                                    <a class="playlist-track" href="#" data-play-track="<?php echo $row->id_jeunesse_musique_grand;  ?>"><?php echo $row->title_jeunesse_musique_grand;  ?></a>
                                </div>
                            </div>
