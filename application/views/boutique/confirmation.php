...
<div class="alert alert-success hidden-md message-confirmation-phone" role="alert">


    <p> <span style="font-size: 2rem; border: 5px solid green; border-radius: 50%; color: green" class="bx bx-check bx-pull-left"></span> <span class="pull-right mt-3" style="color: black">Commande N°: <span style="font-weight: bolder"><?php echo $order_id ?></span> </span> </p>
    <p>ÉTAPES SUIVANTES</p>
    <p style="font-weight: bold">1. Confirmation</p>
    <p>Félicitations! Votre commande a été prise en compte avec succès. Une confirmation vous sera envoyée par mail. Vous pouvez également recevoir un SMS ou un appel de la part de notre Service Client.</p>
...
<section class="mt-0 mx-auto message-confirmation-desktop" style="background-image: url('<?php echo site_url('assets/img/services-bg.jpg') ?>'); padding: 5%">
                      ...
                      <div class="row">
                              ...
                              <div class="col-md-12">
                                  <div style="border: 1px solid #ffd700;border-radius: 10px;opacity: 1; width: 540px; text-align: center; font-size: 25px">
                                      COMMANDE : <span style="font-weight: bold"><?php echo $order_id ?></span>
                                  </div>
