...
<div class="content-wrapper">
    ...
    <div class="box box-primary" style=" width: 800px; margin: 0 auto">
        ...
        <?php if ($this->session->flashdata('error_new_jeunesse_petit')):?>
            <div id="error_info" class="alert-danger" role="alert" style="text-align: center">
                <?php   echo $this->session->flashdata('error_new_jeunesse_petit');?>
            </div> <?php elseif ($this->session->flashdata('success_new_jeunesse_petit')): ?>
            <div id="success_info" class="alert-success" role="alert" style="text-align: center">
                <?php echo $this->session->flashdata('success_new_jeunesse_petit');?>
            </div> <?php endif; ?>

        <!-- form start -->
        <form role="form" method="POST" action="<?php echo site_url('backoffice/admin/addPetitProphetePriere') ?>">
