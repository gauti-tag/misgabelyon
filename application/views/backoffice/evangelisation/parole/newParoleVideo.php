...
<div class="content-wrapper">
    ...
    <div class="box box-primary" style=" width: 800px; margin: 0 auto">
        ...
        <?php if ($this->session->flashdata('error_new_evangelisation_parole_video')):?>
            <div id="error_info" class="alert-danger" role="alert" style="text-align: center">
                <?php   echo $this->session->flashdata('error_new_evangelisation_parole_video');?>
            </div> <?php elseif ($this->session->flashdata('success_new_evangelisation_parole_video')): ?>
            <div id="success_info" class="alert-success" role="alert" style="text-align: center">
                <?php echo $this->session->flashdata('success_new_evangelisation_parole_video');?>
            </div> <?php endif; ?>


        <!-- form start -->
        <form role="form" method="POST" action="<?php echo site_url('backoffice/admin/addParoleVideo') ?>" enctype="multipart/form-data">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="lienVideo" name="lienVideo" required placeholder="https://www.youtube.com/embed/wrvsGI_eI1A">
                </div>
                <div class="form-group">
