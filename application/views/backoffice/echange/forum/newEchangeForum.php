...
<div class="content-wrapper">
    ...
    <div class="box box-primary" style=" width: 800px; margin: 0 auto">
        <!-- form start -->
        <form role="form" method="post"  action="<?php echo site_url('backoffice/admin/addEchangeForum') ?>">
            ...
            <div class="box-body">
                ...
                <?php if ($this->session->flashdata('error_new_echange_forum')):?>
                    <div id="error_info" class="alert-danger" role="alert" style="text-align: center">
                        <?php   echo $this->session->flashdata('error_new_echange_forum');?>
                    </div> <?php elseif ($this->session->flashdata('success_new_echange_forum')): ?>
                    <div id="success_info" class="alert-success" role="alert" style="text-align: center">
                        <?php echo $this->session->flashdata('success_new_echange_forum');?>
                    </div> <?php endif; ?>
