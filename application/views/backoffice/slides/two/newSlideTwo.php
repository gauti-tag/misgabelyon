...
<div class="content-wrapper">
    ...
    <div class="box box-primary" style=" width: 800px; margin: 0 auto">
        ...
        <!-- form start -->
        <?php if ($this->session->flashdata('error_slide_two')):?>
            <div id="error_info" class="alert-danger" role="alert" style="text-align: center">
                <?php   echo $this->session->flashdata('error_slide_two');?>
            </div> <?php elseif ($this->session->flashdata('success_slide_two')): ?>
            <div id="success_info" class="alert-success" role="alert" style="text-align: center">
                <?php echo $this->session->flashdata('success_slide_two');?>
            </div> <?php endif; ?>
        <form role="form" method="POST" action="<?php echo site_url('backoffice/admin/addSlideTwo') ?>" enctype="multipart/form-data">
