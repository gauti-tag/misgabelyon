...
<div class="content-wrapper">
    ...
    <div class="box box-primary" style=" width: 800px; margin: 0 auto">
        ...
        <?php if ($this->session->flashdata('error_new_priere_intention')):?>
            <div id="error_info" class="alert-danger" role="alert" style="text-align: center">
                <?php   echo $this->session->flashdata('error_new_priere_intention');?>
            </div> <?php elseif ($this->session->flashdata('success_new_priere_intention')): ?>
            <div id="success_info" class="alert-success" role="alert" style="text-align: center">
                <?php echo $this->session->flashdata('success_new_priere_intention');?>
            </div> <?php endif; ?>

        <!-- form start -->
        <form role="form" method="POST" action="<?php echo site_url('backoffice/admin/addPriereIntention') ?>">
